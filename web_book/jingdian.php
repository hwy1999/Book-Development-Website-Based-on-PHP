...
<table class="table_one" width="800" height="20" border="0" align="left" cellpadding="0" cellspacing="0">
	<tr>
		<td class="td2" height="20" align="left" ><span class="span1">经典名著</span><hr class="hr_one" style="height:1px;border:none;border-top:1px dashed #CCCCCC;" /></td>
	</tr>
	
</table>
<table class="table_two" width="1100" height="1000"  border="0"  cellpadding="0" cellspacing="0">
	<?php
			 $sql=mysqli_query($conn,"select count(*) as total from book_list  where book_type like('%经典名著%')");
			 ...
			 if($total==0){
			  echo "<div align=center>对不起！暂无书籍！</div>";
			   ...
			   $sql=mysqli_query($conn,"select * from book_list  where book_type like('%经典名著%')  limit ".($page-1)*$pagesize.",$pagesize  ");
